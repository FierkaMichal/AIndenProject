          ...
          <v-card>
            ...
            <v-card-text>
              <v-container grid-list-md>
                ...
                <v-layout row>
                  <v-flex text-xs-center>
                    <img :src="avatarSelected" height="250" alt="avatar">
                  </v-flex>
                </v-layout>
                <v-divider></v-divider>
                <v-layout row>
                ...
                <v-layout row>
                  <v-flex text-xs-center>
                    <img :src="photoSelected" height="250" alt="photo">
                  </v-flex>
                </v-layout>
                <v-divider></v-divider>
                <v-layout row>
      ...
      <v-flex xs12 sm6 offset-sm3 mt-4>
        <v-carousel>
          <v-carousel-item v-for="(photo, i) in user.photoArray"  :key="i" contain>
            <img :src="getImageLink(photo)" alt="photo" style="max-width:90%; height: auto;">
          </v-carousel-item>
        </v-carousel>
      </v-flex>
    </v-layout>
